...
namespace PaintIn3D
{
	...
	public class P3dPaintableTexture : P3dLinkedBehaviour<P3dPaintableTexture>
	{
		...
		/// <summary>You should call this after painting to this paintable texture. All associated IPaintHandlers will be caled from this.</summary>
		...
		{
			return P3dHelper.GetReadableTexture(current);
		}
